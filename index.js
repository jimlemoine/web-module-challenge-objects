...
const pasta = createMenuItem('Pasta', 11, 'Dinner');
console.log('Task 1b ',tacos);
console.log('Task 1b ',pizza);
console.log('Task 1b ',pasta);
...
function addReview(array, name, rating, feedback){
  const newItem = {name, rating, feedback};
  array.push(newItem);
  return array;
}
...
*/
 ...
 function getReviewByRating(array, rating) {
    ...
    for (let i = 0; i < array.length; i++) {
      if (array[i]['rating'] >= rating && array[i]['rating'] < rating+.9) {
...
function carMaker(name, make, miles) {
  return {
    name,
    make,
    miles,
    drive:function(milesDriven){
      this.miles = this.miles + milesDriven;
      return this.miles;
    }
  };  
}
const cruiser = carMaker('rusty', 'toyota', 200000);
cruiser.drive(1000);
console.log('Stretch 3: ',cruiser.miles);
